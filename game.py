...
bright_blue=(173, 241, 255)
bright_purple=(148, 129, 212)
bright_yellow=(241, 255, 48)
display_width=800
display_height=600
import time
import random
...
backgroundpic = pygame.transform.scale(backgroundpic, (110, 1000))
...
def intro_loop():
    ...
    while intro:
        ...
        button("START",150,520,100,50, purple, purple,"play")
        button("QUIT",550,520,100,50, yellow, yellow,"quit")
        button("INSTRUCTION",300,520,200,50, green, green,"intro")
...
def button(msg,x,y,w,h,ic,ac,action=None):
    ...
    if x+w>mouse[0]>x and y+h>mouse[1]>y:
        ...
        pygame.draw.rect(gamedisplays,ic,(x,y,w,h),  border_radius=20)
...
def introduction():
    ...
    while introduction:
        ...
        button("BACK",600,450,100,50,blue,blue,"menu")
        pygame.display.update()
        clock.tick(30)
...
def paused():
    ...
    while pause:
            ...
            gamedisplays.blit(TextSurf,TextRect)
            button("CONTINUE",150,450,150,50,yellow,yellow,"unpause")
            button("RESTART",350,450,150,50,blue,blue,"play")
            button("MAIN MENU",550,450,200,50, pink,pink,"menu")
            pygame.display.update()
            clock.tick(30)
...
def countdown_background():
    ...
    text=font.render("DODGED: 0",True, dark_blue)
    score=font.render("SCORE: 0",True,white)
    gamedisplays.blit(text,(0,50))
    gamedisplays.blit(score,(0,30))
    button("PAUSE",650,0,150,50,pink,pink,"pause")
...
def obstacle(obs_startx,obs_starty,obs):
    if obs==0:
        ...
        obs_pic = pygame.transform.scale(obs_pic, (270, 300))
    elif obs==1:
        obs_pic=pygame.image.load("car2.jpg")
        obs_pic = pygame.transform.scale(obs_pic, (320, 310))
    elif obs==2:
        obs_pic=pygame.image.load("car4.jpg")
        obs_pic = pygame.transform.scale(obs_pic, (130, 210))
    elif obs==3:
        ...
        obs_pic = pygame.transform.scale(obs_pic, (320, 210))
    gamedisplays.blit(obs_pic,(obs_startx,obs_starty))

def score_system(passed,score):
    font=pygame.font.SysFont(None,25)
    text=font.render("PASSED: "+str(passed),True,dark_blue)
